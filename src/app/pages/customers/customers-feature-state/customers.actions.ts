...
const loadCustomersSuccess = createAction(
  '[Customers Effects] load customers success',
  props<{ payload: CustomerPayload }>()
);
const loadCustomersFailure = createAction(
  '[Customers Effects] load customers error',
...
const paginateCustomers = createAction(
  '[Customers Page] paginate customers table',
